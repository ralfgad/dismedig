...
xmvlog -work work_sub -cdslib ./cds.lib -append_log \
    ...
    -status ../src/mult.v ../src/add.v ../src/signature.v ../src/pipeline.v \
    ../src/PS_Demo_core.v ../src/PS_Demo.v

xmvlog -work work -cdslib ./cds.lib -append_log \
    -logfile xmvlog_presyn.log -errormax 15 -update -linedebug \
    -define presyn -status ../src/tb_PS_Demo.v
...
xmsim -cdslib ./cds.lib \
    -logfile xmsim_presyn.log -errormax 15 -status work.tb_PS_Demo:module \
...
genus -wait 60 -legacy_ui -no_gui -overwrite -file ../tcl/PS_Demo_synth.tcl
