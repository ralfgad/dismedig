...
xmvlog -work work -cdslib ./cds.lib -append_log -sv \
    -logfile xmvlog_postsyn.log -errormax 15 -update -linedebug \
    -define postsyn -status ../src/dismedig/fifo_top_test_2020_ver2.sv   ../src/dismedig/fifo_tb_2020_ver1.sv
...
xmsim -GUI -ASSERT_COUNT_TRACES -cdslib ./cds.lib \
    -logfile xmsim_postsyn.log -errormax 15 -status work.fifo_tb:module \
